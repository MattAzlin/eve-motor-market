...
# (Eingerichtet in Sitzung 7, Zahlen zuletzt GEMESSEN am 15.09.2026.)
set -u
cd "$(dirname "$0")"
...
echo "== 2/6 aa-Suite (SOLL 3727/3727) =="
timeout 280 python3 test_bestand_herkunft.py | tail -3

echo "== 3/6 b-Suite (SOLL 1169/1169, endet nach wenigen Sekunden) =="
...
echo "== 6/6 Rotprobe-Anwendbarkeit (SOLL 894/894) =="
python3 rotprobe.py --check

echo ""
echo "SOLL: aa 3727 | b 1169 | Lint 0 | pyflakes 0 | Mutationen 894/894 anwendbar."
