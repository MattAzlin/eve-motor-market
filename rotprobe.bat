...
REM
REM  Ergebnis landet in  rotprobe_komplett.txt  im selben Ordner.
...
echo.
echo  Ergebnis:  rotprobe_komplett.txt
echo ==========================================================
echo.

python rotprobe.py > rotprobe_komplett.txt 2>&1

echo.
echo FERTIG. Die letzte Zeile in rotprobe_komplett.txt sagt,
